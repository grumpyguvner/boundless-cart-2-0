...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<div class="tb_submit clearfix">
		<?php if ($text_agree): ?>
		<?php if ($agree) { ?>
		<label class="checkbox"><input type="checkbox" name="agree" value="1" checked="checked" /> <?php echo $text_agree; ?></label>
		<?php } else { ?>
		<label class="checkbox"><input type="checkbox" name="agree" value="1" class="required" /> <?php echo $text_agree; ?></label>
		<?php } ?>
		<?php endif; ?>
...
tbApp.onScriptLoaded(function() {
	...
	$('#{{widget_dom_id}} .time').find('button').bind('click', function() {
