...
<form id="edit_address_form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="tb_submit clearfix">
    ...
    <button class="tb_button" type="submit"><?php echo $button_continue; ?></button>
  </div>
