...
<?php $tbData->slotStart('product/special.breadcrumbs'); ?>
...
<?php $tbData->slotStart('product/special.page_title'); ?>
<h1><?php echo $heading_title; ?></h1>
<?php $tbData->slotStop(); ?>

<?php // Product listing ---------------------------------------------- ?>

<?php $tbData->slotStart('product/special.products', array('filter' => array('product/special.products.filter|oc_system_products_filter', 'products' => &$products), 'data' => $data)); ?>
<?php if ($products) { ?>
...
<div class="tb_products tb_listing <?php echo $tbData['products_system']['listing_classes']; ?> clearfix">
  ...
  <?php $tbData->slotStart('product/category.products.each', array('products' => $products, 'product' => $product, 'data' => $data)); ?>
