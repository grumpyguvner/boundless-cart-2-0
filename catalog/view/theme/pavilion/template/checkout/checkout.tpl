...
<div class="panel-group checkout" id="accordion">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2 "><?php echo $text_checkout_option; ?></h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2"><?php echo $text_checkout_account; ?></h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2"><?php echo $text_checkout_payment_address; ?></h4>
    </div>
    <div class="panel-collapse collapse" id="collapse-payment-address">
      <div class="panel-body"></div>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2"><?php echo $text_checkout_shipping_address; ?></h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2"><?php echo $text_checkout_shipping_method; ?></h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2"><?php echo $text_checkout_payment_method; ?></h4>
    </div>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title tb_bg_str_2"><?php echo $text_checkout_confirm; ?></h4>
    </div>
...
<script type="text/javascript" src="<?php echo $tbData->theme_catalog_javascript_url; ?>bootstrap.collapse.min.js"></script>
...
tbApp.onScriptLoaded(function() {
    tbCreateDialog('a.agree', $('#{{widget_dom_id}}'));
});
