    ...
    <fieldset id="account">
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        ...
        <div class="col-sm-10">
          ...
          <input type="hidden" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="" />
        </div>
      </div>
      <?php } ?>
...
<div class="tb_submit clearfix">
  <a id="button-register" class="tb_button tb_button_continue"><?php echo $button_continue; ?></a>
</div>
