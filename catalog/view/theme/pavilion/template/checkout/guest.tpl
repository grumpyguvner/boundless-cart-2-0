  ...
  <div class="tb_col_1_2">
    <fieldset id="account">
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        <label class="control-label"><?php echo $custom_field['name']; ?></label>
        <div class="col-sm-10">
          <button type="button" id="button-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
          <input type="hidden" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo (isset($guest_custom_field[$custom_field['custom_field_id']]) ? $guest_custom_field[$custom_field['custom_field_id']] : ''); ?>" />
        </div>
      </div>
      <?php } ?>
...
<div class="tb_submit clearfix">
  ...
  <button id="button-guest" class="tb_button tb_button_primary" type="button"><?php echo $button_continue; ?></button>
</div>
...
tbApp.onScriptLoaded(function() {
  $('.date').find('input[type="text"]').datepicker({
    dateFormat: 'yy-mm-dd',
  ...
  $('.date').find('button').bind('click', function () {
    $(this).parents('.input-group').first().find('input[type="text"]').datepicker('show');
  });

  $('.datetime').find('input[type="text"]').datetimepicker({
    dateFormat: 'yy-mm-dd',
    showOtherMonths: true,
    timeFormat: 'h:m',
    beforeShow: function (input, inst) {
  ...
  $('.datetime').find('button').bind('click', function () {
    $(this).parents('.input-group').first().find('input[type="text"]').datetimepicker('show');
  });

  $('.time').find('input[type="text"]').timepicker({
    timeFormat: 'h:m',
    beforeShow: function (input, inst) {
      var newclass = 'tb_jquery_ui';
      if (!inst.dpDiv.parent().hasClass('tb_jquery_ui')) {
  ...
  $('.time').find('button').bind('click', function () {
