...
class ControllerStoriesShow extends ControllerStoriesCatalog
{
    public function index()
    {
        ...
        $page_title = $settings['lang'][$lang_id]['page_title'] ? $settings['lang'][$lang_id]['meta_title'] : $this->language->get('text_articles');
        ...
        $this->data['breadcrumbs'][] = array(
            'text'      => $story['title'],
            'href'      => $this->url->link('stories/show', 'story_id=' . $story_id),
            'separator' => $this->language->get('text_separator')
        );
