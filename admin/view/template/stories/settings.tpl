      ...
      <div id="tb_cp_content" class="tb_subpanels tb_wrap tb_separate">
        ...
        <form class="tb_col tb_1_1 tb_panel" action="<?php echo $action; ?>" method="post" id="form">
          ...
          <div id="tab-store-general">
            ...
            <fieldset>
              <div class="tb_row_1">
                <label for="auto_seo_url"><?php echo $text_auto_seo_url; ?></label>
            ...
            <fieldset>
              ...
              <div id="tab-store-<?php echo $store['store_id']; ?>-language-<?php echo $language['language_id']; ?>">
                <div class="tb_row_1">
                  ...
                  <span class="tb_language_icon"><img src="view/image/flags/<?php echo $language['image']; ?>"></span>
                ...
                <div class="tb_row_1">
                  ...
                  <span class="tb_language_icon"><img src="view/image/flags/<?php echo $language['image']; ?>"></span>
                  <div class="tb_full clearfix">
                    <textarea name="settings[<?php echo $store['store_id']; ?>][lang][<?php echo $language['language_id']; ?>][meta_description]" value="<?php echo $settings[$store['store_id']]['lang'][$language['language_id']]['meta_description']; ?>" rows="5" cols="100"></textarea>
                  </div>
                </div>
              </div>
              <?php endforeach; ?>
