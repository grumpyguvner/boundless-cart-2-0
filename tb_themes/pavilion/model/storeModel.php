...
class Theme_StoreModel extends TB_ExtensionModel
{
    public function getSubcategoriesDefaultSettings()
    {
        return array(
            'style'          => 1,
            'text_align'     => 'center',
            'image_position' => 1,
            'image_width'    => $this->getOcConfig()->get('config_image_category_width'),
            'image_height'   => $this->getOcConfig()->get('config_image_category_height'),
            'restrictions'   => array(
                0 => array(
                    'max_width'     => 1200,
                    'items_per_row' => 8,
    ...
    public function getProductsDefaultSettings($list_type = null)
    {
        $common = array(
            'products_style'            => 1,
        ...
        $grid = array(
            ...
            'label_new_default'   => 1,
            'stock_default'       => 0,
            'image_width'         => $this->getOcConfig()->get('config_image_product_width'),
            'image_height'        => $this->getOcConfig()->get('config_image_product_height'),
