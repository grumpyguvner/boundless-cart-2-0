<div class="s_builder_row tbBuilderRow" id="row_<?php echo $row['id']; ?>" idstr="<?php echo $row['id']; ?>">
  <div class="s_builder_row_header clearfix">
    <div class="s_builder_row_actions clearfix">
      ...
      <textarea style="display: none;" class="tbBuilderRowSettings"><?php echo $row_settings_encoded; ?></textarea>
  ...
  <div class="s_builder_cols clearfix">
    <div class="s_builder_cols_wrap clearfix">
      ...
      <div class="s_builder_col tb_grid_1_1 tb_empty" grid_proportion="1_1"></div>
      <?php else: $i = 0; ?>
      <?php foreach ($row['columns'] as $column): ?>
      <div id="builder_col_<?php echo $row['id'] . '_' . $i; ?>" class="s_builder_col tb_grid_<?php echo $column['grid_proportion']; ?>" grid_proportion="<?php echo $column['grid_proportion']; ?>"><?php if (isset($column['widgets'])): ?><?php foreach ($column['widgets'] as $widget): ?><div id="<?php echo $widget->getId(); ?>" class="s_widget<?php if ($widget->getClassName() == 'Theme_GroupWidget'): ?> tbGroupWidget<?php endif; ?>"<?php if ($widget instanceof Theme_SystemWidget): ?> name_id="<?php echo $widget->getNameId(); ?>"<?php endif; ?>>
          <h3><?php echo $widget->getPresentationTitle(); ?></h3>
          <div class="s_widget_actions">
            <div class="s_buttons_group">
              <?php if ($widget->getClassName() == 'Theme_GroupWidget'): ?>
          ...
          <div class="s_widget_subwidgets">
            ...
            <div id="<?php echo $subwidget->getId(); ?>" class="s_widget">
