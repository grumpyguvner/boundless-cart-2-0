<div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
  ...
  <div class="tb_tabs_nav">
    <ul class="clearfix">
      ...
      <li class="s_language">
        <a href="#facebook_settings_language_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>">
  ...
  <div id="facebook_settings_language_<?php echo $language_id; ?>">

    <div class="s_row_1">
      <label for="footer_facebook_yes"><?php echo $text_enabled; ?></label>
      <input type="hidden" name="facebook[<?php echo $language_id; ?>][sdk_enabled]" value="0" />
      <label class="tb_toggle"><input id="footer_facebook_yes" type="checkbox" name="facebook[<?php echo $language_id; ?>][sdk_enabled]" value="1"<?php if($theme_settings['facebook'][$language_id]['sdk_enabled'] == '1') echo ' checked="checked"';?> /><span></span><span></span></label>
    </div>

    <div class="s_row_1">
      <label>App ID</label>
      <input type="text" name="facebook[<?php echo $language_id; ?>][app_id]" value="<?php echo $theme_settings['facebook'][$language_id]['app_id']; ?>" />
    </div>

    <div class="s_row_1">
      <label><?php echo $text_label_footer_facebook_locale; ?></label>
      <?php $facebook_locale = $theme_settings['facebook'][$language_id]['locale']; ?>
      <div class="s_select">
        <select name="facebook[<?php echo $language_id; ?>][locale]">
