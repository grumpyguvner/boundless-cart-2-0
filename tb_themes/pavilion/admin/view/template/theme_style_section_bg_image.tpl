<div class="tb_image_row tbBgImageRow">
  <input type="hidden" name="<?php echo $input_property; ?>[background][rows][<?php echo $bg_row_num; ?>][background_type]" value="image" />
  <input type="hidden" name="<?php echo $input_property; ?>[background][rows][<?php echo $bg_row_num; ?>][image]" value="<?php echo $bg_row['image']; ?>" id="bg_image_style_<?php echo $section . '_' . $bg_row_num; ?>"  />
  <div class="tb_wrap">
    <div class="tb_col">
        <span class="tb_thumb">
          <img src="<?php echo $bg_row['preview']; ?>" id="bg_preview_style_<?php echo $section . '_' . $bg_row_num; ?>" class="image" onclick="image_upload('bg_image_style_<?php echo $section . '_' . $bg_row_num; ?>', 'bg_preview_style_<?php echo $section . '_' . $bg_row_num; ?>');" />
        </span>
    </div>
