<fieldset>
      ...
      <div class="s_full clearfix">
        <div class="s_select">
          <select name="<?php echo $input_property; ?>[subcategories][style]">
            ...
            <option value="4"<?php if ($subcategories['style'] == '4'): ?> selected="selected"<?php endif; ?>><?php echo $tbManager->getThemeConfig('name'); ?> light</option>
            <option value="5"<?php if ($subcategories['style'] == '5'): ?> selected="selected"<?php endif; ?>><?php echo $tbManager->getThemeConfig('name'); ?> dark</option>
  ...
  <div class="tb_wrap tb_gut_30">
    ...
    <div class="s_row_2 tb_col tb_1_5 tb_live_row_1 tb_live_1_1 tbSubcategoriesSlider">
      <label>Slider <span class="s_small color_999">(single line)</span></label>
      <span class="clear"></span>
...
<fieldset>
  ...
  <table class="tb_product_elements tb_restrictions_table s_table_1" cellspacing="0">
    ...
    <tr class="s_open s_nosep tbItemsRestrictionRow">
      <td>
        <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[subcategories][restrictions][<?php echo $i; ?>][max_width]" value="<?php echo $row['max_width']; ?>" min="100" max="1200" step="10" size="7" />
        <span class="s_metric">px</span>
      </td>
      <td class="align_left">
        <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[subcategories][restrictions][<?php echo $i; ?>][items_per_row]" value="<?php echo $row['items_per_row']; ?>" min="1" max="8" size="5" />
      </td>
      <td class="align_left">
