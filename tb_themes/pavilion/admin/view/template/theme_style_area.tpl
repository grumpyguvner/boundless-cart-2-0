    ...
    <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
      ...
      <div class="tb_tabs_nav">
        <ul class="clearfix">
          ...
          <li class="s_language">
            <a href="#style_settings_<?php echo $group; ?>_<?php echo $section; ?>_typography_language_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>">
      ...
      <div id="style_settings_<?php echo $group; ?>_<?php echo $section; ?>_typography_language_<?php echo $lid; ?>">
        <?php foreach ($settings['font'][$lid] as $name => $font_section): ?>
        <fieldset class="tb_font_row">
          <legend><?php echo $font_section['section_name']; ?></legend>
          <?php echo $tbData->fetchTemplate('theme_design_typography_item', array('input_property' => "{$group}[{$section}][font][$lid][$name]", 'font' => $font_section, 'font_data' => $font_data)); ?>
        </fieldset>
        <?php endforeach; ?>
      </div>
      <?php endforeach; ?>
