...
<fieldset id="store_common_product_labels">
  ...
  <div class="tb_wrap tb_gut_30">
    <div class="s_row_2 tb_col tb_1_4 tb_live_row_1 tb_live_1_1">
      ...
      <div class="s_full clearfix">
        <div class="s_select">
          <select name="common[currency_label]">
            <option value="code"<?php if($common['currency_label'] == 'code') echo ' selected="selected"';?>>Code</option>
            <option value="symbol"<?php if($common['currency_label'] == 'symbol') echo ' selected="selected"';?>>Symbol</option>
            <option value="title"<?php if($common['currency_label'] == 'title') echo ' selected="selected"';?>>Title</option>
          </select>
        </div>
      </div>
    </div>
    <div class="s_row_2 tb_col tb_1_4 tb_live_row_1 tb_live_1_1">
      ...
      <div class="s_full clearfix">
        <div class="s_select">
          <select name="common[language_label]">
            <option value="flag+code"<?php if($common['language_label'] == 'flag+code') echo ' selected="selected"';?>>Flag + code</option>
            <option value="flag+name"<?php if($common['language_label'] == 'flag+name') echo ' selected="selected"';?>>Flag + name</option>
            <option value="flag"<?php if($common['language_label'] == 'flag') echo ' selected="selected"';?>>Flag only</option>
            <option value="code"<?php if($common['language_label'] == 'code') echo ' selected="selected"';?>>Code only</option>
            <option value="name"<?php if($common['language_label'] == 'name') echo ' selected="selected"';?>>Name only</option>
          </select>
        </div>
      </div>
    </div>
