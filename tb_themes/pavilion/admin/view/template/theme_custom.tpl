<div class="tb_tabs tb_subpanel_tabs">
  ...
  <div id="custom_code_css" class="tb_subpanel">
    ...
    <div class="s_row_2">
      <div class="s_full">
        <textarea name="common[custom_css]" rows="20"><?php echo $common['custom_css']; ?></textarea>
      </div>
    </div>
  ...
  <div id="custom_code_javascript" class="tb_subpanel">
    ...
    <div class="s_row_2">
      <div class="s_full">
        <textarea name="common[custom_javascript]" rows="20"><?php echo $common['custom_javascript']; ?></textarea>
      </div>
    </div>
  </div>
