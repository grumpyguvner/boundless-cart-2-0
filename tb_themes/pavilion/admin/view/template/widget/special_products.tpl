      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <ul class="tb_tabs_nav clearfix">
            ...
            <li class="s_language">
              <a href="#widget_special_products_language_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>">
          ...
          <div id="widget_special_products_language_<?php echo $language_id; ?>" class="s_language_<?php echo $language['code']; ?>">
            <div class="s_row_1">
