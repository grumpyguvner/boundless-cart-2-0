    ...
    <div<?php if ($widget->hasCommonOptions()) echo ' class="tb_tabs tb_subpanel_tabs tbWidgetMainTabs"'; ?>>
      ...
      <div class="tb_tabs_nav">
        <ul class="clearfix">
          ...
          <li><a href="#widget_layout_holder">Layout</a></li>
      ...
      <div id="widget_settings_holder" class="tb_subpanel">
        ...
        <div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
          ...
          <ul class="tb_tabs_nav clearfix">
            ...
            <li class="s_language">
              <a href="#icon_list_widget_language_<?php echo $language['language_id']; ?>">
          ...
          <div id="icon_list_widget_language_<?php echo $language_id; ?>" class="s_language_<?php echo $language['code']; ?> tbLanguagePanel">
            <div class="s_row_1">
            ...
            <div class="s_row_1">
              <div class="s_sortable_holder tb_style_1 tbIconListContainer"><?php $i = 0; foreach ($settings['lang'][$language_id]['rows'] as $row): ?><div class="s_sortable_row tbIconListRow">
                  <div class="s_actions">
                  ...
                  <h3 class="s_drag_area"><span>Row <span class="row_order"><?php echo $i+1; ?></span></span></h3>
                  <div class="tb_wrap">
                    <div class="tb_col tb_1_3">
                      <div class="s_row_1 tbIconRow">
                        <label>Icon</label>
                        <div class="tbIcon<?php if (!$row['glyph_value']): ?> s_icon_holder s_h_26<?php endif; ?>">
                        ...
                        <?php endif; ?>
                        <input type="hidden" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][glyph_value]" value="<?php echo $row['glyph_value']; ?>" />
                      </div>
                      <div class="s_row_1">
                        <label>Icon color</label>
                        <div class="colorSelector"><div style="background-color: <?php echo $row['glyph_color']; ?>;"></div></div>
                        <input type="text" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][glyph_color]" value="<?php echo $row['glyph_color']; ?>" />
                      </div>
                      <div class="s_row_1">
                        ...
                        <input type="text" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][box_color]" value="<?php echo $row['box_color']; ?>" />
                      </div>
                      <div class="s_row_1">
                        <label>Icon size</label>
                        <input class="s_spinner glyph_size" type="text" size="6" min="8" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][glyph_size]" value="<?php echo $row['glyph_size']; ?>" />
                        <span class="s_metric">px</span>
                      </div>
                      <div class="s_row_1">
                        <label>Box size</label>
                        <input class="s_spinner" type="text" size="6" min="10" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][box_size]" value="<?php echo $row['box_size']; ?>" />
                        <span class="s_metric">px</span>
                      </div>
                      <div class="s_row_1">
                        ...
                        <div class="s_full">
                          <div class="s_select">
                            <select name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][icon_style]">
                              <option value="1"<?php if ($row['icon_style'] == '1'): ?> selected="selected"<?php endif; ?>><?php echo $tbManager->getThemeConfig('name'); ?></option>
                    ...
                    <div class="tb_col tb_2_3">
                      <div class="s_row_1 s_mb_20">
                        ...
                        <input type="text" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][url]" value="<?php echo $row['url']; ?>" size="39" />
                        <span class="s_metric">
                          <select name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][url_target]">
                      ...
                      <div class="s_row_1">
                        <textarea id="icon_list_widget_row_text_<?php echo $language_id; ?>_<?php echo $i; ?>" class="tbCKE" name="widget_data[lang][<?php echo $language_id; ?>][rows][<?php echo $i; ?>][text]" cols="30"><?php echo $row['text']; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div><?php $i++; endforeach; ?></div>

              <a href="#" class="tbAddIconRow s_button s_white s_h_30 s_icon_10 s_plus_10 right" language_id="<?php echo $language_id; ?>">Add Icon</a>
      ...
      <div id="widget_layout_holder" class="tb_subpanel">
        ...
        <div class="s_row_1 opt_column_spacing">
          <label>Spacing</label>
          <input class="s_spinner" name="widget_data[grid_gut]" type="text" value="<?php echo $settings['grid_gut']; ?>" min="0" max="50" step="10" size="6" />
          <span class="s_metric">px</span>
        </div>
...
function addIconRow(language_id, row_num) {
  ...
  var $row = $(output).appendTo("#icon_list_widget_language_" + language_id + " div.s_sortable_holder");
...
$(document).ready(function() {
  ...
  $icon_list_widget_form.on("click", ".tbChooseIcon", function() {
  ...
  $.each($sReg.get('/tb/language_ids'), function(key, value) {
  ...
  $widget_icon_list.find(".tbAddIconRow").bind("click", function() {
    ...
    $new_row = addIconRow(language_id, ++num_rows[language_id]);
  ...
  $("#widget_icon_list_display").bind("change", function() {
    ...
    $elf(".opt_column_spacing").toggle(val == 'inline');
    ...
    <div class="tb_wrap" style="display: none;">
      <div class="tb_col tb_1_3">
        <div class="s_row_1 tbIconRow">
          ...
          <a class="s_button s_white s_h_26 s_icon_10 s_plus_10 tbChooseIcon" href="javascript:;">Choose</a>
          <input type="hidden" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][glyph_value]" />
        </div>
        <div class="s_row_1">
          <label>Icon color</label>
          <div class="colorSelector"><div style="background-color: #333333;"></div></div>
          <input type="text" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][glyph_color]" value="#333333" />
        </div>
        <div class="s_row_1">
          <label>Box/border color</label>
          <div class="colorSelector tbBackgroundColor colorpicker_no_color"><div></div></div>
          <input type="text" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][box_color]" value="" />
        </div>
        <div class="s_row_1">
          <label>Icon size</label>
          <input class="s_spinner" type="text" size="5" min="8" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][glyph_size]" value="14" />
          <span class="s_metric">px</span>
        </div>
        <div class="s_row_1">
          <label>Box size</label>
          <input class="s_spinner glyph_size" type="text" size="5" min="10" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][box_size]" value="14" />
          <span class="s_metric">px</span>
        </div>
        <div class="s_row_1">
          <label>Icon Style</label>
          <div class="s_full">
            <div class="s_select">
              <select name="widget_data[lang][{{language_id}}][rows][{{row_num}}][icon_style]">
                <option value="1"><?php echo $tbManager->getThemeConfig('name'); ?></option>
      ...
      <div class="tb_col tb_2_3">
        <div class="s_row_1 s_mb_20">
          <label><strong>Icon Link</strong></label>
          <input type="text" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][url]" size="39" />
          <span class="s_metric">
            <select name="widget_data[lang][{{language_id}}][rows][{{row_num}}][url_target]">
              <option>_self</option>
        ...
        <div class="s_row_1">
          <textarea id="icon_list_widget_row_text_{{uid}}" class="tbCKE" name="widget_data[lang][{{language_id}}][rows][{{row_num}}][text]" cols="30"></textarea>
        </div>
      </div>
    </div>
  </div>
