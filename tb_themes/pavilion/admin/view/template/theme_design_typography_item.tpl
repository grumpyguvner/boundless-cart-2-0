...
<?php
$options = (int) $font['has_size'] + (int) $font['has_line_height'] + (int) $font['has_effects'] + (int) $font['has_spacing'] * 2;
if ($font['built-in'] && $options > 2 || !$font['built-in']) {
...
<div class="tb_wrap tb_gut_30 tbFontItem">
  <div class="tb_col tb_1_3 s_row_2 s_full"<?php if ($font['built-in']) echo ' style="display: none;"'; ?>>
  ...
  <div class="tb_col <?php echo $option_col; ?> s_row_2">
    <div class="tb_wrap tb_gut_30">
      <div class="tb_col <?php echo $font_style_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 fontfamily">
        <label class="subtle">Font Family</label>
      ...
      <div class="tb_col <?php echo $font_style_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 fontstyle tbFontProperty"<?php if (!$font['type'] || $font['family'] == 'inherit' || ($font['type'] == 'built' && !$font['show_built_styles'])): ?> style="display: none"<?php endif; ?>>
        <label class="subtle">Font Style</label>
        <div class="s_full clearfix">
    ...
    <?php if($options > 2 || !$font['built-in']): ?>
    </div>
    <div class="tb_wrap tb_gut_30">
    <?php endif; ?>
      <?php if ($font['has_size']): ?>
      <div class="tb_col <?php echo $font_option_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 tbFontProperty"<?php if ($font['family'] == 'inherit'): ?> style="display: none"<?php endif; ?>>
        <label class="subtle">Font size</label>
        <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[size]" value="<?php echo $font['size']; ?>" min="8" size="6" />
        <span class="s_metric">px</span>
      </div>
      <?php endif; ?>
      <?php if ($font['has_line_height']): ?>
      <div class="tb_col <?php echo $font_option_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 tbFontProperty tbLineHeight"<?php if ($font['family'] == 'inherit'): ?> style="display: none"<?php endif; ?>>
        <label class="subtle">Line height</label>
        <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[line-height]" value="<?php echo $font['line-height']; ?>" min="10" size="6" />
        <span class="s_metric">px</span>
      </div>
      <?php endif; ?>
      <?php if ($font['has_spacing']): ?>
      <div class="tb_col <?php echo $font_option_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 tbFontProperty"<?php if ($font['family'] == 'inherit'): ?> style="display: none"<?php endif; ?>>
        <label class="subtle">Letter spacing</label>
        <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[letter-spacing]" value="<?php echo $font['letter-spacing']; ?>" step="0.1" size="6" />
        <span class="s_metric">px</span>
      </div>
      <div class="tb_col <?php echo $font_option_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 tbFontProperty"<?php if ($font['family'] == 'inherit'): ?> style="display: none"<?php endif; ?>>
        <label class="subtle">Word spacing</label>
        <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[word-spacing]" value="<?php echo $font['word-spacing']; ?>" size="6" />
        <span class="s_metric">px</span>
      </div>
      <?php endif; ?>
      <?php if ($font['has_effects']): ?>
      <div class="tb_col <?php echo $font_option_col; ?> s_row_2 tb_live_row_1 tb_live_1_1 tbFontProperty"<?php if ($font['family'] == 'inherit'): ?> style="display: none"<?php endif; ?>>
        <label class="subtle">Transform</label>
        <div class="s_full clearfix">
          <div class="s_select">
