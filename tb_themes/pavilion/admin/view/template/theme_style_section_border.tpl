...
<fieldset class="tb_border_radius">
  ...
  <div class="tb_wrap clear">
    ...
    <p class="s_help">Border radius <strong>DOES NOT</strong> work with IE 7/8. You can check a detailed compatibility list <a href="http://caniuse.com/border-radius" target="_blank">here</a>.</p>
