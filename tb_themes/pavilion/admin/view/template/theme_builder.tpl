      ...
      <div id="layout_builder_widgets_custom" class="tb_subpanel">
        <div class="s_builder_row_widgets_listing clearfix">
          ...
          <div class="tbWidgetsList">
            ...
            <div class="s_widget<?php if ($widget->getClassName() == 'Theme_GroupWidget'): ?> tbGroupWidget<?php endif; ?> tbWidget" id_prefix="<?php echo $widget->getClassName(); ?>">
...
$(document).ready(function() {
  ...
  $("#tb_cp_layout_builder_widgets_panel").find("div.tb_tabs").first().tabs();
...
<script type="text/template" id="group_widget_template">
  <div class="s_widget s_expanded group_widget_container_interface ui-state-disabled">
    ...
    <div class="s_save_box">
      <a class="s_button button_update s_red s_h_24 tbGroupWidgetUpdate" href="#">Update</a>
    </div>
  </div>
</script>
