        ...
        <table class="tb_product_elements tb_restrictions_table s_table_1" cellspacing="0">
          ...
          <tbody class="tbItemsRestrictionsWrapper">
            ...
            <tr class="s_open s_nosep tbItemsRestrictionRow">
              <td>
                <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][restrictions][<?php echo $i; ?>][max_width]" value="<?php echo $row['max_width']; ?>" min="100" max="1200" step="10" size="7" />
                <span class="s_metric">px</span>
              </td>
              <td class="align_left">
                <input class="s_spinner" type="text" name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][restrictions][<?php echo $i; ?>][items_per_row]" value="<?php echo $row['items_per_row']; ?>" min="1" max="8" size="5" />
              </td>
              <td class="align_left">
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][products_style]">
              <option value="1"<?php if ($ptype['products_style'] == '1'): ?> selected="selected"<?php endif; ?>>Plain</option>
              <option value="2"<?php if ($ptype['products_style'] == '2'): ?> selected="selected"<?php endif; ?>>Bordered</option>
              <option value="3"<?php if ($ptype['products_style'] == '3'): ?> selected="selected"<?php endif; ?>>Separated</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][cart_button_size]">
              <option value="20"<?php if ($ptype['cart_button_size'] == '20'): ?> selected="selected"<?php endif; ?>>Tiny</option>
              <option value="24"<?php if ($ptype['cart_button_size'] == '24'): ?> selected="selected"<?php endif; ?>>Small</option>
              <option value="30"<?php if ($ptype['cart_button_size'] == '30'): ?> selected="selected"<?php endif; ?>>Medium</option>
              <option value="34"<?php if ($ptype['cart_button_size'] == '34'): ?> selected="selected"<?php endif; ?>>Large</option>
              <option value="40"<?php if ($ptype['cart_button_size'] == '40'): ?> selected="selected"<?php endif; ?>>Huge</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][cart_button_position]">
              <option value="1"<?php if ($ptype['cart_button_position'] == '1'): ?> selected="selected"<?php endif; ?>>Default</option>
              <option value="2"<?php if ($ptype['cart_button_position'] == '2'): ?> selected="selected"<?php endif; ?>>Inline</option>
              <option value="3"<?php if ($ptype['cart_button_position'] == '3'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom right)</option>
              <option value="4"<?php if ($ptype['cart_button_position'] == '4'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom)</option>
              <option value="5"<?php if ($ptype['cart_button_position'] == '5'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom left)</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][compare_button_size]">
              <option value="20"<?php if ($ptype['compare_button_size'] == '20'): ?> selected="selected"<?php endif; ?>>Tiny</option>
              <option value="24"<?php if ($ptype['compare_button_size'] == '24'): ?> selected="selected"<?php endif; ?>>Small</option>
              <option value="30"<?php if ($ptype['compare_button_size'] == '30'): ?> selected="selected"<?php endif; ?>>Medium</option>
              <option value="34"<?php if ($ptype['compare_button_size'] == '34'): ?> selected="selected"<?php endif; ?>>Large</option>
              <option value="40"<?php if ($ptype['compare_button_size'] == '40'): ?> selected="selected"<?php endif; ?>>Huge</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][compare_button_position]">
              <option value="1"<?php if ($ptype['compare_button_position'] == '1'): ?> selected="selected"<?php endif; ?>>Default</option>
              <option value="2"<?php if ($ptype['compare_button_position'] == '2'): ?> selected="selected"<?php endif; ?>>Inline</option>
              <option value="3"<?php if ($ptype['compare_button_position'] == '3'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom right)</option>
              <option value="4"<?php if ($ptype['compare_button_position'] == '4'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom)</option>
              <option value="5"<?php if ($ptype['compare_button_position'] == '5'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom left)</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][wishlist_button_size]">
              <option value="20"<?php if ($ptype['wishlist_button_size'] == '20'): ?> selected="selected"<?php endif; ?>>Tiny</option>
              <option value="24"<?php if ($ptype['wishlist_button_size'] == '24'): ?> selected="selected"<?php endif; ?>>Small</option>
              <option value="30"<?php if ($ptype['wishlist_button_size'] == '30'): ?> selected="selected"<?php endif; ?>>Medium</option>
              <option value="34"<?php if ($ptype['wishlist_button_size'] == '34'): ?> selected="selected"<?php endif; ?>>Large</option>
              <option value="40"<?php if ($ptype['wishlist_button_size'] == '40'): ?> selected="selected"<?php endif; ?>>Huge</option>
            </select>
          </div>
        </div>
      </div>
        ...
        <div class="s_full clearfix">
          <div class="s_select">
            <select name="<?php echo $input_property; ?>[products][<?php echo $list_type; ?>][wishlist_button_position]">
              <option value="1"<?php if ($ptype['wishlist_button_position'] == '1'): ?> selected="selected"<?php endif; ?>>Default</option>
              <option value="2"<?php if ($ptype['wishlist_button_position'] == '2'): ?> selected="selected"<?php endif; ?>>Inline</option>
              <option value="3"<?php if ($ptype['wishlist_button_position'] == '3'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom right)</option>
              <option value="4"<?php if ($ptype['wishlist_button_position'] == '4'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom)</option>
              <option value="5"<?php if ($ptype['wishlist_button_position'] == '5'): ?> selected="selected"<?php endif; ?>>Overlap thumbnail (bottom left)</option>
            </select>
          </div>
        </div>
      </div>
