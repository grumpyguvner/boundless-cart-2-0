          ...
          <div class="s_row_2 tb_col tb_1_6 tb_live_row_1 tb_live_1_1 tbSettingsRow">
            ...
            <div class="s_select">
              <select name="slider[header_style]">
                <option value="visible"<?php if ($slider['header_style'] == 'fixed')    echo ' selected="selected"'; ?>>Visible</option>
                <option value="hidden" <?php if ($slider['header_style'] == 'hidden')   echo ' selected="selected"'; ?>>Hidden</option>
                <?php /* <option value="overlay"<?php if ($slider['header_style'] == 'absolute') echo ' selected="selected"'; ?>>Overlay</option> */ ?>
              </select>
            </div>
          </div>
          <div class="s_row_2 tb_col tb_1_6 tb_live_row_1 tb_live_1_1">
...
<div class="s_submit clearfix">
  <a href="javascript:;" class="s_button s_white s_h_40 left tbCancelSlider">Back to list</a>
...
$container.find(".tbAddSliderSize").bind("click", function() {
  ...
  $(output).appendTo($('.tbSliderSizes')).find(".s_spinner").each(function() {
    $(this).spinner({
      mouseWheel: true
    });
  });
        ...
        <div id="slide_{{row_num}}_layer_{{row_title_num}}_styles">
          ...
          <fieldset>
            ...
            <div class="tb_wrap tb_gut_30">
              ...
              <div class="s_row_2 tb_col tb_1_6 tb_live_row_1 tb_live_1_1">
                <label>Scale</label>
                <input class="s_spinner" type="text" name="keyframes[0].style.scale" value="1" size="7" min="0" />
              </div>
              <div class="s_row_2 tb_col tb_1_6 tb_live_row_1 tb_live_1_1">
